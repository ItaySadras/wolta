...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post("http://localhost:8000/registerUser", data, {
      ...
      <div className="register-container">
        ...
        <div className="register-form">
          <form onSubmit={handleSubmit(onSubmit)}> 
            ...
            <input className="register-input" placeholder="Username" {...register("username", { required: true })} />
            {errors.username && toast.error("Username is required")}

            <label>Password</label>
            <input className="register-input" placeholder="Password" type="password" {...register("password", { required: true })} />
            {errors.password && toast.error("Password is required")}

            <label>Confirm password</label>
            <input className="register-input" placeholder="Confirm Password" type="password" {...register("confirmPassword", {
            ...
            <label>Email</label>
            <input className="register-input" placeholder="Email" {...register("email", { required: true })} />
            {errors.email && toast.error("Email is required")}

            <label>Phone number</label>
            <input className="register-input" placeholder="Phone number" {...register("phoneNumber", { required: true })} />
